  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved poll as @poll" do
        ...
        post :create, {:poll => { "content" => "invalid value" }}, valid_session
        assigns(:poll).should be_a_new(Poll)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested poll" do
        ...
        Poll.any_instance.should_receive(:update).with({ "content" => "MyString" })
        put :update, {:id => poll.to_param, :poll => { "content" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the poll as @poll" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Poll.any_instance.stub(:save).and_return(false)
        put :update, {:id => poll.to_param, :poll => { "content" => "invalid value" }}, valid_session
        assigns(:poll).should eq(poll)
      end
